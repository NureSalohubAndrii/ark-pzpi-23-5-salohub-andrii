...
export async function logVerificationCode(email: string, code: string): Promise<void> {
...
export const sendVerificationEmailDev =
  process.env.NODE_ENV === 'development' ? logVerificationCode : sendVerificationEmail;
